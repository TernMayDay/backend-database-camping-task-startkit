...
-- set 
--   cancelled_at = '024-11-24 17:00:00', 
--   status = '課程已取消'
-- where
...
-- join "COACH" on "COACH".id = "COACH_LINK_SKILL".coach_id
-- join "USER" on "USER".id = "COACH".user_id
-- where 
...
-- where 
--   "CREDIT_PURCHASE".created_at between '2024-11-01 00:00:00' and '2024-11-30 23:59:59'
...
-- from "COURSE_BOOKING"
-- where
--   "COURSE_BOOKING".created_at between '2024-11-01 00:00:00' and '2024-11-30 23:59:59'
